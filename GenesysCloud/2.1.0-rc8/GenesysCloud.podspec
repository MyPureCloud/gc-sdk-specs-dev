...
Pod::Spec.new do |s|
  ...
  s.source = {
  "http" => "https://genesysdx.jfrog.io/artifactory/genesys-cloud-ios.dev/GenesysCloud/GenesysCloud-2.1.0-rc8.zip"
  }
  ...
  s.subspec 'Core' do |sp|
    ...
    sp.dependency 'GenesysCloudCore', '2.1.0-rc8'
    sp.dependency 'GenesysCloudMessenger', '2.1.0-rc8'
