...
Pod::Spec.new do |s|
  ...
  s.source = {
  "http" => "https://purecloud.jfrog.io/purecloud/genesys-cloud-ios.dev/GenesysCloud/GenesysCloud-0.2.1-SNAPSHOT-feature-gmms-15160-ios-pure-jfrog-7.zip"
  }
  ...
  s.subspec 'Core' do |sp|
    ...
    sp.dependency 'GenesysCloudCore', '0.2.1-SNAPSHOT-feature-gmms-15160-ios-pure-jfrog-7'
    sp.dependency 'GenesysCloudMessenger', '0.2.1-SNAPSHOT-feature-gmms-15160-ios-pure-jfrog-7'
