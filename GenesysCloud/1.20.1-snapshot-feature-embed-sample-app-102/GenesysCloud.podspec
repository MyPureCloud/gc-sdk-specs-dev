...
Pod::Spec.new do |s|
  s.name             = 'GenesysCloud'
  s.version          = '1.20.1-snapshot-feature-embed-sample-app-102'
  ...
  s.source = {
  "http" => "https://genesysdx.jfrog.io/artifactory/genesys-cloud-ios.dev/GenesysCloud/GenesysCloud_version_1.20.1-snapshot-feature-embed-sample-app-102.zip"
  }
  ...
  s.subspec 'Core' do |sp|
    ...
    sp.dependency 'GenesysCloudCore', '1.20.1-snapshot-feature-embed-sample-app-102'
    sp.dependency 'GenesysCloudMessenger', '1.20.1-snapshot-feature-embed-sample-app-102'
