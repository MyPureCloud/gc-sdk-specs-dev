...
Pod::Spec.new do |s|
  ...
  s.source = {
  "http" => "https://genesysdx.jfrog.io/artifactory/genesys-cloud-ios.dev/GenesysCloud/GenesysCloud_version_0.0.3-SNAPSHOT-PR-22-16_commit_a4fc426874fa2689b6246ea7be2ed4830dc25400.zip"
  }
  ...
  s.subspec 'Core' do |sp|
    ...
    sp.dependency 'GenesysCloudCore', '0.0.3'
    sp.dependency 'GenesysCloudMessenger', '0.0.3'
