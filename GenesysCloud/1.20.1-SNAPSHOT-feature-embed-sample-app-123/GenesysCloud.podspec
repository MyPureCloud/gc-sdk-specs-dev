...
Pod::Spec.new do |s|
  s.name             = 'GenesysCloud'
  s.version          = '1.20.1-SNAPSHOT-feature-embed-sample-app-123'
  ...
  s.source = {
  "http" => "https://genesysdx.jfrog.io/artifactory/genesys-cloud-ios.dev/GenesysCloud/GenesysCloud-1.20.1-SNAPSHOT-feature-embed-sample-app-123.zip"
  }
  ...
  s.subspec 'Core' do |sp|
    ...
    sp.dependency 'GenesysCloudCore', '1.20.1-SNAPSHOT-feature-embed-sample-app-123'
    sp.dependency 'GenesysCloudMessenger', '1.20.1-SNAPSHOT-feature-embed-sample-app-123'
