...
Pod::Spec.new do |s|
    ...
    s.source = {
        "http" => "https://genesysdx.jfrog.io/artifactory/genesys-cloud-ios.dev/GenesysCloudAccessibility/GenesysCloudAccessibility_version_t1.8.2.rc1_commit_969afb23bdbee57bafa6fca635042a86369399a7.zip"
    }
