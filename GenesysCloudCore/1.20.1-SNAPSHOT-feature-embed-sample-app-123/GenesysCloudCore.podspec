...
GenesysCloudCore SDK
  ...
  s.source           = { :http => 'https://genesysdx.jfrog.io/artifactory/genesys-cloud-ios.dev/GenesysCloudCore/GenesysCloudCore-1.20.1-SNAPSHOT-feature-embed-sample-app-123.zip' }
