...
GenesysCloudMessenger is an SDK that used as chat handler for bold API.
  ...
  s.source = {
  "http" => "https://genesysdx.jfrog.io/artifactory/genesys-cloud-ios.dev/GenesysCloudMessenger/GenesysCloudMessenger_version_t1.10.0.rc1_commit_451277ce3e2fbcf5030371d38721a011c00c3a80.zip"
  }
  ...
  s.dependency 'GenesysCloudMessengerTransport', '2.7.0'
  s.swift_version = '5.0'
