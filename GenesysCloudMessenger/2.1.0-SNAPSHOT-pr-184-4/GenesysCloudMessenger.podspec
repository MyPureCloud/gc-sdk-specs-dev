...
Pod::Spec.new do |s|
  ...
  s.version          = '2.1.0-SNAPSHOT-pr-184-4'
...
GenesysCloudMessenger is an SDK that used as chat handler for GenesysCloud API.
  ...
  s.source = {
  "http" => "https://genesysdx.jfrog.io/artifactory/genesys-cloud-ios.dev/GenesysCloudMessenger/GenesysCloudMessenger-2.1.0-SNAPSHOT-pr-184-4.zip"
  }
  ...
  s.dependency 'GenesysCloudCore', '2.1.0-SNAPSHOT-pr-184-4'
  s.dependency 'GenesysCloudMessengerTransport', '2.12.0-rc3'
