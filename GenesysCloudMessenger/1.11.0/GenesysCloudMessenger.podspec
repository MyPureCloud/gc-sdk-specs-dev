...
GenesysCloudMessenger is an SDK that used as chat handler for GenesysCloud API.
  ...
  s.source = {
  "http" => "https://genesysdx.jfrog.io/artifactory/genesys-cloud-ios.dev/GenesysCloudMessenger/GenesysCloudMessenger_version_t1.11.0.rc7_commit_a7aa532ab0a2f97a1f92f7f90a4afa8b523a2254.zip"
  }
  ...
  s.dependency 'GenesysCloudMessengerTransport', '2.8.0-rc1'
  s.swift_version = '5.0'
