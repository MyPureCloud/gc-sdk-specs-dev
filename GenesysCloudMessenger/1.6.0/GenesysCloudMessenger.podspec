...
GenesysCloudMessenger is an SDK that used as chat handler for bold API.
  ...
  s.source = {
  "http" => "https://genesysdx.jfrog.io/artifactory/genesys-cloud-ios.dev/GenesysCloudMessenger/GenesysCloudMessenger_version_t1.6.0.rc6_commit_65827090991cb9bffa552dbf892ce0afed677d9b.zip"
  }
  ...
  s.dependency 'MessengerTransport2', '2.5.1'
  s.swift_version = '5.0'
