...
Pod::Spec.new do |s|
  ...
  s.version          = '2.2.0-SNAPSHOT-pr-224-2'
...
GenesysCloudMessenger is an SDK that used as chat handler for GenesysCloud API.
  ...
  s.source = {
  "http" => "https://genesysdx.jfrog.io/artifactory/genesys-cloud-ios.dev/GenesysCloudMessenger/GenesysCloudMessenger-2.2.0-SNAPSHOT-pr-224-2.zip"
  }
  ...
  s.dependency 'GenesysCloudCore', '2.2.0-SNAPSHOT-pr-224-2'
  s.dependency 'GenesysCloudMessengerTransport', '2.13.0-rc1'
