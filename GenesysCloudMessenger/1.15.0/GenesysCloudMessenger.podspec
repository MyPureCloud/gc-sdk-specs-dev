...
GenesysCloudMessenger is an SDK that used as chat handler for GenesysCloud API.
  ...
  s.source = {
  "http" => "https://genesysdx.jfrog.io/artifactory/genesys-cloud-ios.dev/GenesysCloudMessenger/GenesysCloudMessenger_version_t1.15.0.rc46_commit_2e8bdda855e93a78015900e7e1327341da4d52e0.zip"
  }
  ...
  s.dependency 'GenesysCloudMessengerTransport', '2.9.0-rc8'
  s.swift_version = '5.0'
