...
GenesysCloudMessenger is an SDK that used as chat handler for GenesysCloud API.
  ...
  s.source = {
  "http" => "https://genesysdx.jfrog.io/artifactory/genesys-cloud-ios.dev/GenesysCloudMessenger/GenesysCloudMessenger_version_t0.0.2.rc33_commit_fc8e76f35dde667be1a0ddc3814dc64ce5141e73.zip"
  }
  ...
  s.dependency 'GenesysCloudCore', '0.0.2'
  s.dependency 'GenesysCloudMessengerTransport', '2.8.7-rc2'
  s.swift_version = '5.0'
